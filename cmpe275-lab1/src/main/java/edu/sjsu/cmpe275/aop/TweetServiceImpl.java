...
public class TweetServiceImpl implements TweetService {
	...
	/***
	 * Following is a dummy implementation. You can tweak the implementation to
	 * suit your need, but this file is NOT part of the submission.
	 */
	/**
	 * Tweet Method.
	 */
	...
	public void tweet(String user, String message) throws IllegalArgumentException, IOException {
		...
		// if (temp >1) {
		// ///System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~Throwing an
		// IOexception " + temp);
